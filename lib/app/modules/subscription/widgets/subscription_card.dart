                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .bodyLarge
                          ?.copyWith(color: AppColors.white, fontSize: width * .09),
                    ),
                    Padding(
                        ...
                        children: <Widget>[
                          Text(
                            ...
                            style: Theme.of(context)
                                ...
                                .bodySmall
                                ?.copyWith(
                                color: AppColors.white, fontSize: 26, height: 3),
                          ),
                          int.parse(offer) > 0
                              ? Padding(
                          ...
                          Text(
                            ...
                            style: Theme.of(context)
                                ...
                                .bodyLarge
                                ?.copyWith(
                                color: AppColors.white, fontSize: 18, height: 2.7),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .bodyLarge
                              ?.copyWith(color: AppColors.white, fontSize: width * .06),
                        ),
                      ),
                    ),

...
import '../modules/reupload_images/bindings/reupload_images_binding.dart';
import '../modules/reupload_images/views/reupload_images_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.REUPLOAD_IMAGES,
      page: () => const ReuploadImagesView(),
      binding: ReuploadImagesBinding(),
    ),
  ];
}
